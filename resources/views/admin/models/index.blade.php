...
<section class="content permission-page"><br>
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div class="mb-2">
                <h1 class="page-title mb-1">Model Management</h1>
                <div class="page-subtitle">
                    Manage application models with a cleaner and more user-friendly admin experience.
                </div>
            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <div class="card-count text-primary">
                                    {{ $models->count() ?? 0 }} <small class="text-muted text-sm">Total Models</small>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $models->count() ?? 0 }} <small class="text-muted text-sm">Active Models</small>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $models->count() ?? 0 }} <small class="text-muted text-sm">Inactive Models</small>                                    
                                </div>
                            </div>
...
<!-- 
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $models->count() }} <small class="text-muted text-sm">Showing Current Page Items</small> 
            ...
            <div class="card-header d-none d-lg-block">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-2 mb-md-0">
                        ...
                        <i class="fas fa-layer-group text-primary mr-2"></i>Model List
                        </h3>
                    </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap" id="infoTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="permission-name">{{ $item->brand ? $item->brand->name : 'N/A' }}</div>
                            </td>
                            <td> 
                            @if($item->status == 1)
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ route('admin.models.destroy', $item->id) }}" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted mb-4">
                            You haven’t created any models yet. Start by adding your first model.
                        </p>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-bold" id="addPermissionLabel">
                                <i class="fas fa-plus-circle text-success mr-2"></i>Add New Model
                            </h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="font-weight-semibold">Model Name <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                ...
                                <small class="form-text text-muted">Enter the name of the model.</small>
                            </div>

                            <div class="form-group">
                                <label class="font-weight-semibold"> Brand  <span class="text-danger">*</span>  </label>
                                <select name="brand_id" class="form-control select2"  required style="width: 100%;">
                                    <option value="">Select Brand</option>
                                    @foreach ($brands as $brand)
                                        <option value="{{  $brand->id }}" {{ (collect(old('brand_id'))->contains($brand->id)) ? 'selected' : '' }}>
                                            {{ $brand->name }}
                                        </option>
                                    @endforeach
                                </select>
                                <small class="form-text text-muted">
                                    Select the brand associated with this model.
                                </small>
                            </div>
        ...
        <div class="modal fade" id="ediModal-{{ $item->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered-" role="document">
                <form method="POST" action="{{ route('admin.models.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-bold" id="editLabel-{{ $item->id }}">
                                <i class="fas fa-edit text-primary mr-2"></i>Update Model
                            </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
