...
<section class="content permission-page"><br>
    <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                <div class="mb-2">
                    <h1 class="page-title mb-1">Deleted suppliers Management</h1>
                    <div class="page-subtitle">
                        Manage deleted application supplierss with a cleaner and more user-friendly admin experience.
                    </div>
                </div>
            </div>
                            ...
                            <tr id="noSearchResultRow" style="display:none;">
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <div class="font-weight-bold">No matching suppliers found</div>
