...
<section class="content permission-page"><br>
    <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                <div class="mb-2">
                    <h1 class="page-title mb-1">Deleted Machine Type Management</h1>
                    <div class="page-subtitle">
                        Manage deleted application machine types with a cleaner and more user-friendly admin experience.
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center action-group">
                                    ...
                                    <form method="POST" action="{{ route('admin.machine-types.restore', $item->id) }}" class="d-inline">
                                        @csrf
                                        @method('POST')
