...
<section class="content permission-page"><br>
    <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                <div class="mb-2">
                    <h1 class="page-title mb-1">Deleted Supplires Management</h1>
                    <div class="page-subtitle">
                        Manage deleted application Supplires with a cleaner and more user-friendly admin experience.
                    </div>
                </div>
            </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover mb-0" id="brandTable">
                        ...
                        <tbody>
                            @foreach ($needle_types as $key => $item)
                            <tr>
                                <td>
                                    <span class="badge badge-light px-3 py-2">
                                        {{ method_exists($needle_types, 'firstItem') ? $needle_types->firstItem() + $key : $key + 1 }}
                                    </span>
                                </td>
                                <td>
                                    {{ $item->needle_type }}
                                ...
                                <td class="text-center action-group">
                                    ...
                                    <form method="POST" action="{{ route('admin.needletype.restore', $item->id) }}" class="d-inline">
                                        @csrf
                                        @method('POST')
              ...
              @if(method_exists($needle_types, 'links'))
