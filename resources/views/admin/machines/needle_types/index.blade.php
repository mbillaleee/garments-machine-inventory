...
<section class="content permission-page"><br>
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div class="mb-2">
                <h1 class="page-title mb-1">Needle Type Management</h1>
            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <div class="card-count text-primary">
                                    {{ $needleType->count() ?? 0 }} <small class="text-muted text-sm">Total Models</small>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $needleType->count() ?? 0 }} <small class="text-muted text-sm">Active Models</small>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $needleType->count() ?? 0 }} <small class="text-muted text-sm">Inactive Models</small>                                    
                                </div>
                            </div>
...
<!-- 
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $needleType->count() }} <small class="text-muted text-sm">Showing Current Page Items</small> 
            ...
            <div class="card-header d-none d-lg-block">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-2 mb-md-0">
                        ...
                        <i class="fas fa-layer-group text-primary mr-2"></i>Needle Type  List
                        </h3>
                    </div>
                    <div class="col-md-8 d-flex justify-content-end align-items-center mb-2 mb-md-0">
                        <div class="d-flex align-items-center w-100">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="{{ route('admin.needletypes.index') }}" class="btn btn-tool">
                                    <i class="fas fa-sync-alt text-success text-lg"></i>
                                </a>

                               <a href="{{ route('admin.needletype.deleteditems') }}" class="btn btn-tool">
              ...
              <div class="card-header d-block d-lg-none">
                <h3 class="card-title">Needle Type </h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap" id="infoTable">
                        ...
                        <tbody>
                        @foreach ($needleType as $key => $item)
                        <tr>
                            <td>
                                <span class="badge badge-light px-3 py-2">
                                    {{ method_exists($needleType, 'firstItem') ? $needleType->firstItem() + $key : $key + 1 }}
                                </span>
                            </td>
                            <td>
                                <div class="permission-name">{{ $item->needle_type }}</div>
                            </td>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ route('admin.needletypes.destroy', $item->id) }}" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title font-weight-bold" id="addPermissionLabel">
                                        <i class="fas fa-plus-circle text-success mr-2"></i>Update Needle Type
                                    </h5>
                                    ...
                                    <!-- form start -->
                                    <form class="form-horizontal" method="POST" action="{{ route('admin.needletypes.update', $item->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-4 col-form-label">Needle Type</label>
                                                <div class="col-sm-8">
                                                <input type="text" class="form-control" id="inputEmail3" placeholder="Needle Type" name="needle_type" required value="{{ $item->needle_type}}">
                                                </div>
                                            </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted mb-4">
                            You haven’t created any Needle Types yet. Start by adding your first Needle Type.
                        </p>
              ...
              @if(method_exists($needleType, 'links'))
        ...
        <div class="modal fade" id="modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="card card-info">
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('admin.needletypes.store') }}"> 
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Needle Type</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" placeholder="Needle Type" name="needle_type" required>
                            </div>
                        </div>
