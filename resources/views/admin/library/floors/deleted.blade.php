...
<section class="content permission-page"><br>
    <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                <div class="mb-2">
                    <h1 class="page-title mb-1">Deleted Floor Management</h1>
                    <div class="page-subtitle">
                        Manage deleted application Floors with a cleaner and more user-friendly admin experience.
                    </div>
                </div>
            </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Deleted Floors</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center action-group">
                                    ...
                                    <form method="POST" action="{{ route('admin.floors.restore', $item->id) }}" class="d-inline">
                                        @csrf
                                        @method('POST')
