...
<section class="content permission-page"><br>
    <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                <div class="mb-2">
                    <h1 class="page-title mb-1">Deleted Locations Management</h1>
                    <div class="page-subtitle">
                        Manage deleted application Locations with a cleaner and more user-friendly admin experience.
                    </div>
                </div>
            </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Deleted Locations</h3>
