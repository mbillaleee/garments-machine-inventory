                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <div class="card-count text-primary">
                                    {{ $data->count() ?? 0 }} <small class="text-muted text-sm">Total Departments</small>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $data->count() ?? 0 }} <small class="text-muted text-sm">Active Departments</small>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="card-title"></div>
                                <div class="card-count text-primary">
                                    {{ $data->count() ?? 0 }} <small class="text-muted text-sm">Inactive Departments</small>                                    
                                </div>
                            </div>
            ...
            <div class="card-header d-none d-lg-block">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-2 mb-md-0">
                        ...
                        <i class="fas fa-layer-group text-primary mr-2"></i>Department  List
                        </h3>
                    </div>
                ...
                <form class="form-horizontal" method="POST" action="{{ route('admin.departments.store') }}">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">Department Name</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputEmail3" placeholder="Department Name" name="department_name" required>
                            </div>
                        </div>
